...
import { appendToHistory, loadHistory, loadMostRecentHistory } from "../../src/core/history.js";
...
describe("event history", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "sonar-history-"));
  ...
  it("does nothing when sessionId is undefined", () => {
    ...
    const historyDir = path.join(tmpDir, "claude-sonar", "history");
