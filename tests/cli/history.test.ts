...
import { appendToHistory } from "../../src/core/history.js";
import { historyCommandNonInteractive } from "../../src/cli/commands/history.js";
...
describe("history CLI (non-interactive)", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "sonar-cli-history-"));
