...
program
  .command("setup")
  .description("Register sonar hooks in Claude Code settings")
  .action(() => {
    setupCommand();
  });
...
program
  .command("uninstall")
  .description("Remove sonar hooks from Claude Code settings")
  .action(() => {
    uninstallCommand();
  });
...
const configCmd = program
  .command("config")
  .description("Manage claude-sonar configuration");
