 ...
 * Pure function — no I/O.
 */
export function processHookEvent(rawInput: string, config: SonarConfig): FormatResult {
 ...
 */
export function processToolUse(rawInput: string, config: SonarConfig): FormatResult {
 ...
 */
function handlePostToolUse(event: PostToolUseEvent, config: SonarConfig): FormatResult {
 ...
 */
function handleNotification(event: NotificationEvent, config: SonarConfig): FormatResult {
 ...
 */
function handleStop(event: StopEvent, config: SonarConfig): FormatResult {
 ...
 */
function handleSubagentStart(event: SubagentStartEvent, config: SonarConfig): FormatResult {
 ...
 */
function handleTaskCompleted(event: TaskCompletedEvent, config: SonarConfig): FormatResult {
 ...
 */
function handlePreToolUse(event: PreToolUseEvent, config: SonarConfig): FormatResult {
 ...
 */
function isSilenced(toolName: string, config: SonarConfig): boolean {
